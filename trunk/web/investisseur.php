...
<div id='main' role='main'>
	<div id='main-content-header'>
		<div class='container'>
			<div class='row'>
				<div class='col-sm-12'>
					<h1 class='title'>Invertisseur</h1>
					<ol class='breadcrumb'>
				...
				<div class='col-sm-12'>
					...
					<div class='row'>
						...
						<div class='col-sm-6'>
							...
							<p>
								<img src="assets/images/investisseur.jpg"
					...
					<div class='form-actions mg-t-lg'>
						<div class='row'>
                            ...
                            <?php
    							...
    							echo "<a class='btn btn-contrast' href='formInvestisseur.php'
									style='margin-left: 75px;'> <i class='icon-save'></i> JE CREE
									MON COMPTE POUR SOUTENIR LES JEUNES
								</a>";}
                                ?>
							</div>
						</div>
