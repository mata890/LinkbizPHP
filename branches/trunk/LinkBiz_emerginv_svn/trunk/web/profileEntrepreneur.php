						...
						<div class='col-sm-4 panel-item'>
							<a class='panel panel-image'>
								...
								<div class='panel-body'>
									<h3 class='panel-title'>Barry Al Assane</h3>
									<p align="left">Enseignant-Chercheur|Université de l'Avenir</p>
									<p align="left">Dakar-Sénégal, BP 934</p>
									<p align="left">charabia@gmail.com</p>
								</div>
							</a>
						</div>
                ...
                <div class='row panels'>
                  <div class='col-sm-4 panel-item'>
                    <a class='panel panel-image'>
                      ...
                      <div class='panel-heading'><img class="img-responsive-sm" alt="Project planning" width="768" height="300" src="assets/images/demo/panels/panel_bg_chess.jpg" /></div>
                      <div class='panel-body'>
                        <h3 class='panel-title'>Barry Al Assane</h3>
                        <p align="left">Enseignant-Chercheur|UniversitÃ© de l'Avenir</p>
						<p align="left">Dakar-SÃ©nÃ©gal, BP 934</p>
						<p align="left">charabia@gmail.com</p>
                      </div>
                    </a>
                  </div>
                ...
                <div class='icon-boxes icon-boxes-lg'>
                  ...
                  <div class='row'>
                    <div class='col-sm-6 icon-box'>
                      ...
                      <div class='content'>
                        <h3 class='title'>Customers</h3>
                        <p>Pellentesque sit amet est sit amet eros consectetur elementum sed et mauris. Pellentesque interdum eu elit nec imperdiet.</p>
                      </div>
                    </div>
                    <div class='col-sm-6 icon-box'>
                      <div class='icon icon-wrap icon-circle icon-lg contrast-bg'>
                    ...
                    <div class='carousel-inner'>
                      ...
                      <div class='item quote'>
                        <div class='col-sm-12 text-center'>
                          ...
                          <div class='author-wrapper'>
                            <p class='author'>
                              <strong>PaÄ¾o DelinÄ�Ã¡k</strong>,
                              Bublina Studio
                            </p>
                          </div>
                        </div>
                      ...
                      <div class='col-sm-8 col-sm-offset-1'>
                               <div class="form-group">
                                     <label>Témoignage</label>
                                        <textarea class="form-control" id="input-textarea" placeholder="Ajouter vos appréciations par rapport aux services de LinkBiz" rows="4"></textarea>
                               </div>
                       </div>
                        <div class='col-md-6 col-md-offset-3'>
                            <a class='btn btn-contrast' href='Entrepreneurtemoignagepost.php' style="margin-left: 75px;">
                            <i class='icon-save'></i>
