							...
							<div style="height: auto;" class="panel-collapse in"
								...
								<div class="panel-body">
									...
									<p class="dropcap-contrast text-justify">
										...
										financement attendu,le chiffre d'affaire,le résumé du projet,
										etc.
									</p>
									<p class=" dropcap-contrast text-justify">Ainsi votre annonce
										sera visible pour tous les visiteurs,particulièrement les
										investisseurs inscrits sur la plateforme. Soyez précis et
										convaincant au moment de remplir le formulaire,pour augmenter
										vos chances qu'un investisseur entre en relation direct avec
										vous.</p>
									<p class="dropcap-contrast text-justify">Lorsqu'un investisseur
										est intéressé par votre annonce,vous serez notifié par mail de
										l'intérêt de celui-ci.</p>
								</div>
							</div>
						</div>
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a class="accordion-toggle collapsed" data-parent="#accordion2"
										data-toggle="collapse" href="#accordion2-item-2"> Le projet </a>
								</h4>
							</div>
							<div style="height: 0px;" class="panel-collapse collapse"
								id="accordion2-item-2">
								<div class="panel-body">Une idée, un projet, une entreprise à
									développer, une reprise d’entreprise, une LBO, un OBO… ; vous
									recherchez un partenariat financier ou bien agrandir votre
									réseau.</div>
							</div>
						</div>
						<div class="panel panel-default">
							...
							<div style="height: 0px;" class="panel-collapse collapse"
								...
								<div class="panel-body">Notre plateforme est disponible pour
									vous, votre proposition d’affaire est mise en ligne
									gratuitement et sera vu par un cercle d’investisseur du monde
									entier.</div>
							</div>
						</div>
						<div class="panel panel-default">
							...
							<div class="panel-collapse collapse" id="accordion2-item-4">
								<div class="panel-body">Nos investisseurs ont différents profils
									qu’ils soient investisseur providentiel, individuel, industriel
									; capital risqueur, business angel ; selon leur profil, ils se
									metteront en contact avec vous pour satisfaire vos besoins ou
									développer une collaboration future.</div>
							</div>
						</div>
					</div>
				</div>
